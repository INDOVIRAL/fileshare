...
**If you need any more modes in repo or If you find out any bugs, mention in [@indonesia_viral ](https://www.telegram.dog/indonesia_viral)**
...
#### Deploy in your VPS
````bash
git clone https://github.com/INDOVIRAL/fileshare
cd fileshare
